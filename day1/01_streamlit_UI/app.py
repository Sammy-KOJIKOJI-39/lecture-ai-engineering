...
st.markdown(
    ...
    [data-testid="stSidebar"] {
        background-color: #f3e8ff; /* サイドバー背景：薄紫色 */
        color: #d2691e;            /* サイドバーの通常テキスト：濃い橙色 */
    }
    /* sidebar.info（アラートボックス）部分 */
    [data-testid="stSidebar"] .stAlert {
        background-color: #f3e8ff; /* infoの背景も薄紫色 */
        color: #4b0082;            /* info内の文字色：濃い紫色 */
    }
    </style>
    """,
